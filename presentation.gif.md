...
<!-- MAP:title_bg -->
<img src="./figures/maps_gif/title_bg.gif" alt="title bg map" class="bg-map-frame">
...
<div class="gem-row">
<!-- MAP:gem_exposure -->
<img src="./figures/maps_gif/gem_exposure.gif" alt="gem exposure map" class="gem-exposure-bg">
...
<!-- MAP:gem_exposure -->
<img src="./figures/maps_gif/gem_exposure.gif" alt="gem exposure map" class="conclusion-item">
<!-- MAP:intro_conclusion -->
<img src="./figures/maps_gif/intro_conclusion.gif" alt="intro conclusion map" class="conclusion-item">
