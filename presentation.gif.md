...
<!-- MAP:gem_exposure (gif fallback) -->
<img src="./figures/maps_gif/gem_exposure.gif" alt="gem exposure map" style="width:56%; height:470px;">
...
<!-- MAP:intro (gif fallback) -->
<img src="./figures/maps_gif/intro.gif" alt="intro map">
...
<!-- MAP:intro_attributes (gif fallback) -->
<img src="./figures/maps_gif/intro_attributes.gif" alt="intro attributes map">
...
<!-- MAP:height (gif fallback) -->
<img src="./figures/maps_gif/height.gif" alt="height map">
...
<!-- MAP:relative_position (gif fallback) -->
<img src="./figures/maps_gif/relative_position.gif" alt="relative position map">
...
<!-- MAP:shape_parameters (gif fallback) -->
<img src="./figures/maps_gif/shape_parameters.gif" alt="shape parameters map">
...
<!-- MAP:roof_material (gif fallback) -->
<img src="./figures/maps_gif/roof_material.gif" alt="roof material map">
...
<!-- MAP:year (gif fallback) -->
<img src="./figures/maps_gif/year.gif" alt="year map">
...
<!-- MAP:structural_system_split (gif fallback) -->
<img src="./figures/maps_gif/structural_system_split.gif" alt="structural system split map">

---

<!-- _class: map -->

<!-- MAP:structural_system_metrics (gif fallback) -->
<img src="./figures/maps_gif/structural_system_metrics.gif" alt="structural system metrics map">

---

<!-- _class: map -->

<!-- MAP:structural_system_feature_importance (gif fallback) -->
<img src="./figures/maps_gif/structural_system_feature_importance.gif" alt="structural system feature importance map">

---

<!-- _class: map -->

<!-- MAP:structural_system_comparison (gif fallback) -->
<img src="./figures/maps_gif/structural_system_comparison.gif" alt="structural system comparison map">
...
<!-- MAP:gem_exposure (gif fallback) -->
<img src="./figures/maps_gif/gem_exposure.gif" alt="gem exposure map" style="width:32%; height:420px;">
<!-- MAP:intro_conclusion (gif fallback) -->
<img src="./figures/maps_gif/intro_conclusion.gif" alt="intro conclusion map" style="width:32%; height:420px;">
